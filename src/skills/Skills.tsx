...
import {faCss3, faGitSquare, faHtml5, faReact, faSass, faSquareJs} from "@fortawesome/free-brands-svg-icons";
    ...
    return <section id={'skills'} className={style.skillsBlock}>
        <div className={`${style.skillsContainer} ${container.container}`}>
            ...
            <div className={style.skills}>
                ...
                <Skill title={'CSS'}
                       description={' consectetur adipisicing elit. Commodi dolor earum illo magni molestiae. Ab ?'}>
                    <FontAwesomeIcon icon={faCss3}/>
                </Skill>
                <Skill title={'React'}
                       description={'Lorem ipsum dolor sitipisicin earum illo magni mole'}>
